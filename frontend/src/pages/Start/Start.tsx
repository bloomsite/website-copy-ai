        ...
        <section className="start-intro">
          <div className="intro-content">
            ...
            <p className="intro-description">
              Selecteer het type pagina waarvoor je op maat gemaakte content
              wilt genereren. Onze AI zal de perfecte teksten creëren die
              aansluiten bij jouw beroep en doelgroep.
            </p>
            ...
            <div className="intro-benefits">
              ...
              <ul className="benefits-list">
                <li>
                  <strong>Gerichte boodschap:</strong> Elke pagina heeft een
                  uniek doel en vereist specifieke toon en inhoud
                </li>
                <li>
